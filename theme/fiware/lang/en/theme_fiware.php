...
/**
 * Strings for component 'theme_fiware', language 'en'
 *
...
<img class=img-polaroid src="fiware/pix/fiware_academy.jpg" />
<h3>Theme Credits</h3>
<p>
<h3>Moodle FIWARE theme</h3>
<p>
...
$string['navigatordesc'] = 'This This section i s used to configure if you want or no the navigator module';
$string['navigatorheading'] = 'Navigator module';
$string['navigatorheadingsub'] = 'Navigator for the front page';
...
$string['togglenavigator'] = 'Navigator display';
$string['togglenavigatordesc'] = 'Choose if you wish to hide or show the navigator module in front page.';
/*  UNUSED in FIWARE
