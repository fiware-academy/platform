...
$numberofslides = theme_fiware_get_setting('numberofslides');
if ($numberofslides>0) { ?>
  ...
  <div id="home-page-carousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
     <?php for($s1=1;$s1<=$numberofslides;$s1++): 
		...
		$slidecaption = theme_fiware_get_setting('slide' . $s1 . 'caption', true);
		$slideurl = theme_fiware_get_setting('slide' . $s1 . 'url');
		$slideimg = theme_fiware_render_slideimg($s1,'slide' . $s1 . 'image');
		?>
	      <div class="item<?php echo $cls_txt2; ?>" style="background-image: url(<?php echo $slideimg; ?>);">
	          <div class="carousel-overlay-content">
	            <div class="content-wrap">
	              ...
	              <a href="<?php echo $slideurl; ?>" class="read-more"><?php echo get_string('readmore','theme_fiware'); ?><i class="fa fa-angle-right"></i></a>
	            </div>
	          </div>
	      </div>
      <?php endfor; ?>
