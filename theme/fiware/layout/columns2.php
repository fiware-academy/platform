...
echo $OUTPUT->doctype();
/*
$PAGE->requires->js('/theme/fiware/javascript/bootstrap-carousel.js');
$PAGE->requires->js('/theme/fiware/javascript/bootstrap-transition.js');
// Need to overload old css definitions
$PAGE->requires->css('/theme/fiware/style/custom.css');
