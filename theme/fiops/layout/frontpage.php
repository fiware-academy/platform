...
<head>
	...
	<link href="/theme/fiops/css/custom_style.css" rel="stylesheet" type="text/css">
	<script src="/theme/fiops/js/jquery.js"></script>
	...
	<link href="/theme/fiops/cookies/cookies_policy.css" rel="stylesheet" type="text/css">
    <script src="/theme/fiops/cookies/cookies_policy.js"></script>
</head>
...
<!-- START OF HEADER -->
 ...
 <li><a href="/mod/forum/view.php?id=1">News</a></li>      </ul>
  	</div>
	<?php } ?>
...
<!-- START OF FOOTER -->
    ...
    <div id="page-footer">
        <div class="crediti">
        © 2014 fi-ops (Easing your operations)
        </div>
